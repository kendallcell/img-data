...
Functions for recognizing and inspecting AI generation metadata.

This module receives raw AI metadata text and converts it into a structured,
human-readable representation. It does not read image files and it does not
...
def looks_like_ai_metadata(text: str) -> bool:
    ...
    Multiple generation-related markers are required so ordinary image
    comments are not incorrectly classified as AI metadata.
    """
